...
public class Game{
    ...
    public Room goRoom(){
        ...
        if(direction.equals("north")) return currentRoom.getNorthExit();
        
        if(direction.equals("east")) return currentRoom.getEastExit();
    
        if(direction.equals("south")) return currentRoom.getSouthExit();

        if(direction.equals("west")) return currentRoom.getWestExit();
